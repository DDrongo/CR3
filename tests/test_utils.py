...
def test_get_data(test_url):
    ...
    assert get_data('http://wrong.url.com/')[0] is None
    assert get_data('https://github.com/DDrongo/CR3')[0] is None
    assert get_data('https://github.com/DDrongo/CR4')[0] is None
